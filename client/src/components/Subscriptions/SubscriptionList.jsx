...
import AdvancedSubscriptionTable from './AdvancedSubscriptionTable';
      ...
      <div className="card-header">
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <div className="view-mode-toggle" style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <button
              className={`btn btn-sm ${viewMode === 'advanced' ? 'btn-primary' : 'btn-secondary'}`}
              onClick={() => setViewMode('advanced')}
              title="Расширенная таблица"
            >
              ⚡ Расширенная
            </button>
          </div>
          <Link to="/subscriptions/create-multistep" className="btn btn-success">
            📝 Мультишаговая форма
          </Link>
